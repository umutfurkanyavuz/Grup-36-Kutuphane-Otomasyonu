...
namespace Kutuphane_Otomasyonu
{
    public partial class UyeKitapAra : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            DbCon dbcon = new DbCon();
            con = dbcon.connection();
            OracleCommand komut = new OracleCommand("SELECT * FROM Books WHERE BookName LIKE '%" + textBox1.Text + "%' or BookAuthor like '%" + textBox1.Text + "%' or BookPublisher like '%" + textBox1.Text + "%'", con);
